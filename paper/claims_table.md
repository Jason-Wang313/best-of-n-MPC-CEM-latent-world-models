...
| CEM can underperform static proposals in the pocket world. | Partial but strong in the current full run: CEM regret `11.64`, Best-of-N `6.16`. | `results/controlled/controlled_rollouts.csv` |
